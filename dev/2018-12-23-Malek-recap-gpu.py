...
class Net(torch.nn.Module):
    ...
    def __init__(self, n_hidden1, n_hidden1_white, n_hidden2, n_hidden3, n_hidden4, n_output):
        ...
        ## White
        self.conv1_white = nn.Conv3d(2, 16, 3, bias = BIAS_CONV, stride=1, padding=1).to(device)
        self.conv2_white = nn.Conv3d(16, 64, 3, bias = BIAS_CONV, stride=1, padding=1).to(device)
        self.conv3_white = nn.Conv3d(64, 256, 3, bias = BIAS_CONV, stride=1, padding=1).to(device)
