...
class Net(torch.nn.Module):
    ...
    def __init__(self):
        ...
        ## Convolution
        self.conv1 = nn.Conv3d(2, 128, 3, bias = BIAS_CONV, stride=1, padding=1)
        self.conv2 = nn.Conv3d(128, 256, 3, bias = BIAS_CONV, stride=1, padding=1)
        self.conv3 = nn.Conv3d(256, 256, 3, bias = BIAS_CONV, stride=1, padding=1)
    ...
    def forward(self, image):
        ...
        h_out2 = F.relu(self.out2(h_out1))
        resp =  self.predict(h_out2)
        return resp
