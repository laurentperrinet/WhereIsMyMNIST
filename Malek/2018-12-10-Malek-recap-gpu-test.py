...
# ## test retour à une archi à couches sans convolution
...
FIC_NAME = '2018-12-10-Malek-recap-kernel-3-multi-1-nhidden1-500-gpu-test'
EPOCHS = 1500
...
transform = Transform(tensor = False)
transform_test = Transform(tensor = False, test = True)
...
class Net(torch.nn.Module):
    ...
    def __init__(self, n_hidden1, n_hidden1_white, n_hidden2, n_hidden3, n_hidden4, n_output):
        ...
        self.hidden1_white = torch.nn.Linear(N_theta * N_azimuth * N_eccentricity * N_phase, n_hidden1_white, bias = BIAS).to(device)
