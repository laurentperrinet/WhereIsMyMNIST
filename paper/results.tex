...
\begin{figure}[t!]%%[p!]
	...
	\caption{
		{\A-- \E Active vision samples after training}. \A-- \B  classification success samples. \C-- \E classification failure samples. Digit contrast set to 0.7.  From left to right :~{\bf a.} The initial 128$\times$128 visual display, with blue cross giving the center of gaze.
