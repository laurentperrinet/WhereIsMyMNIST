...
From the active inference standpoint, a simple independence assumption  justifies the separation of the scene analysis in those two independent tasks (see Methods). %A first task consists in identifying the target (namely inferring $y$ from $x$) and a second task consists in localizing the target (namely inferring $u$ from $x$).
