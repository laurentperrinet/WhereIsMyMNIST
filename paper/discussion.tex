...
Our main modelling assumption here is an \emph{accuracy-driven} monitoring of action, stating in short that the ventral classification accuracy drives the dorsal selection of action maps. {\color{magenta} [TODO] Biological evidence for accuracy-map driven action selection? \citep{joel2002actor}}
