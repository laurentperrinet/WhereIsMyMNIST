...
We start from an elementary visual search problem, that is how to localize an object in a large, crowded image, and take human vision as a guide for efficient design. Our framework is made as general as possible, with minimal mathematical treatment, to allow consistency with fragmented domains, such as machine learning, neuroscience and robotics. We expect to provide an integrated view of foveated active vision, applicable to both domains. 
