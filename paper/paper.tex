...
Learning where to look: a foveated visuomotor control model (à changer)
...
\author{\AuthorED \inst{1}\orcidID{0000-1111-2222-3333} \and \AuthorPA \inst{1,2} \and \AuthorLP \inst{2}\orcidID{\orcidLP }  }
